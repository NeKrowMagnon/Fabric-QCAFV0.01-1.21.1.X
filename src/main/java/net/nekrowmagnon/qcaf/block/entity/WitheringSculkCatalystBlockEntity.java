...
public class WitheringSculkCatalystBlockEntity extends BlockEntity implements GameEventListener.Holder<WitheringSculkCatalystBlockEntity.Listener> {
private final WitheringSculkCatalystBlockEntity.Listener eventListener;

public WitheringSculkCatalystBlockEntity(BlockPos pos, BlockState state) {
    super(ModBlockEntities.WITHERING_SCULK_CATALYST, pos, state);
    this.eventListener = new WitheringSculkCatalystBlockEntity.Listener(state, new BlockPositionSource(pos));
}

public static void tick(World world, BlockPos pos, BlockState state, WitheringSculkCatalystBlockEntity blockEntity) {
...
public WitheringSculkCatalystBlockEntity.Listener getEventListener() {
...
public static class Listener implements GameEventListener {
    ...
    private void bloom(ServerWorld world, BlockPos pos, BlockState state, Random random) {
        world.setBlockState(pos, state.with(WitheringSculkCatalystBlock.BLOOM, Boolean.TRUE), Block.NOTIFY_ALL);
